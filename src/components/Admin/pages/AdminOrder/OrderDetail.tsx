...
const OrderDetail = () => {
    ...
    return (
        <div className='product-process'>
            ...
            <Grid container xs={12} mb={2} mt={2} ml={2}>
                <Grid item xs={3}>
                    Họ tên:
                </Grid>
                <Grid item xs={9}>
            ...
            <Grid container xs={12} mb={2} mt={2} ml={2}>
                <Grid xs={3}>Số điện thoại:</Grid>
                <Grid item xs={9}>
                    {order.phone}
                </Grid>
            </Grid>
            <Grid container xs={12} mb={2} mt={2} ml={2}>
                <Grid xs={3}>Địa chỉ:</Grid>
                <Grid item xs={9}>
                    {order.address}
                </Grid>
            </Grid>

            <Grid container xs={12} mb={4} mt={2} ml={2}>
                <Grid xs={3}>Ghi chú:</Grid>
                <Grid item xs={9}>
                    {order.note}
                </Grid>
            </Grid>
            ...
            <div
                style={{
                    ...
                    backgroundImage:
                        "repeating-linear-gradient(45deg, rgb(111, 166, 214), rgb(111, 166, 214) 33px, transparent 0px, transparent 41px, rgb(241, 141, 155) 0px, rgb(241, 141, 155) 74px, transparent 0px, transparent 82px)",
                }}
            ></div>
            <div className='row p-5' style={{ backgroundColor: "#FFFCF5" }}>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className='order-details__title'>
                                {product.name}
                                <div className='order-details__num'>x{product.quantity}</div>
                            </div>
                        </div>
                ...
                >
                    ...
                    <div style={{ margin: "0 8px" }}>Tổng số tiền: </div>
                    <div style={{ color: "#ee4d2d" }}>{formatPrice(order.sumMoney)}đ</div>
                </div>
            </div>
            <Grid xs={12} style={{ justifyContent: "flex-end", display: "flex" }}>
                <Button
                    variant='contained'
                    disableElevation
                    style={{ marginTop: "32px", marginLeft: "auto" }}
                >
                    <Link to={"/admin/orders"} style={{ textDecoration: "none", color: "#fff" }}>
                        Trở Lại
                    </Link>
                </Button>
            </Grid>
